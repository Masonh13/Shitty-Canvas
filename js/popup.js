...
function displayCustomFont() {
    chrome.storage.sync.get(["custom_font"], storage => {
        ...
        linkContainer.innerHTML = 'Link: <input class="card-input" id="custom-font-link"></input> Family: <input class="card-input" id="custom-font-family"></input> Format: <input class="card-input" id="custom-font-format"></input>';
        let link = linkContainer.querySelector("#custom-font-link");
        let family = linkContainer.querySelector("#custom-font-family");
        let format = linkContainer.querySelector("#custom-font-format");
        link.value = storage.custom_font.link;
        family.value = storage.custom_font.family;
        format.value = storage.custom_font.format;

        link.addEventListener("change", e => chrome.storage.sync.set({ "custom_font": { "link": linkContainer.querySelector("#custom-font-link").value, "family": linkContainer.querySelector("#custom-font-family").value, "format": linkContainer.querySelector("#custom-font-format").value } }));
        family.addEventListener("change", e => chrome.storage.sync.set({ "custom_font": { "link": linkContainer.querySelector("#custom-font-link").value, "family": linkContainer.querySelector("#custom-font-family").value, "format": linkContainer.querySelector("#custom-font-format").value } }));
        format.addEventListener("change", e => chrome.storage.sync.set({ "custom_font": { "link": linkContainer.querySelector("#custom-font-link").value, "family": linkContainer.querySelector("#custom-font-family").value, "format": linkContainer.querySelector("#custom-font-format").value } }));
    });
}
